...
<!-- header -->
    <div id="container_header">
        <header>
            <div id="header_logo">
                <a href="#"><img src="../assets/logo_left.png" id="main_logo" alt="Logo groupomania" /></a>
            </div>
            <nav id="nav_header">
                <img  v-if="admin" src="../assets/logo_admin.jpg" id="logo_admin" class="header_navbar_menu" alt="Logo administrateur" />
